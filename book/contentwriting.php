                    ...
                    <div class="container text-white">
                        <div class="row  text-center">
                            <div class="col-sm-12 col-md-12 col-lg-12 custom-margin-y">
                                <h1 class="hero-text">Content Writing</h1>
                                <p class="hero-para mt-4">At Mega Book Writing, we have dedicated field experts assigned with the various services and have all the resources to serve to our clients. Get a free consultation now.</p>
                ...
                <div class="container-fluid">
                    <div class="container">
                        <div class="row ">
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-12 p-3 card-body-border-gradient">
