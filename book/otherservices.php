                ...
                <div class="container bg-light">
                    <div class="row p-3">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <h5><u>Professional Marketing Assistants</u></h5>
                            <p class="section-text">Social Media Set-up</p>
                            <p class="section-text">Creative and Appealing Bookmarks</p>
                            <p class="section-text">Digital Postcards</p>
                            <p class="section-text">Business Cards</p>
                            <p class="section-text">Small and Attractive Posters</p>
                            <p class="section-text">Book Video Trailiers</p>
                            <p class="section-text">Press Release</p>
                            <p class="section-text">Marketing on Social Media Platforms</p>
                            <p class="section-text">Marketing Consultation</p>
                            <p class="section-text">Amazon Kindle</p>
                            <p class="section-text">Apple Books</p>
                            <p class="section-text">Barnes and Noble Book Edition</p>
                            <p class="section-text">Audio Book</p>
                            <p class="section-text">Author Website</p>
                            <p class="section-text">Article Writing</p>

                        </div>
                        <div class="col-lg-6 d-none d-sm-none d-lg-block d-md-block text-end">
                            <h1 style="text-align:left;">Personal Marketing Assistants</h1>
                            <p style="text-align:left;">Our marketing assistants will help to promote your book through various online and offline channels. They will also help to create a buzz around your book through social media and other online platforms.</p>
                            <img src="assets/section-content-photo-1.png" width="543px" height="500px" />
                        </div>
