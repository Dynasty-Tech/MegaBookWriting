    ...
    <div class="container">
        <div class="row px-3">
            <div class="col-sm-12 col-md-12 col-lg-12 text-start text-lg-center">
                ...
                <a class="btn btn-theme-outlined " type="submit" href="contact.php"><i class="bi bi-arrow-up-right"></i> Learn more</a>
            </div>
        </div>
        ...
        <div class="row justify-content-center my-3" >
            <div class="col-lg-3 col-md-6 col-sm-12  mx-2 my-2">
                <!--CARDS-->
                <div class="card custom-card-height card-color" data-aos="flip-right">
