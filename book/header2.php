                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active text-white" aria-current="page" href="ebook.php">E-Book</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-white" href="contentwriting.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Content Writing
                                </a>
                                <ul class="dropdown-menu">
