...
<head>
  ...
  <title>Megabook writing | About</title>
      ...
      <div class="container pt-10 pt-md-14 text-center">
        <div class="row">
          <div class="col-xl-6 mx-auto">
            <h1 class="display-1 mb-4">Hello! This is megabook</h1>
          ...
          <div class="col-lg-6">
            ...
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p class="mb-0"><a href="mailto:megabook@email.com" class="link-body">megabook@email.com</a></p>
              </div>
            </div>
          </div>
          <!--/column -->
